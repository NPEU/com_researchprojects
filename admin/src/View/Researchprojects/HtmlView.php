...
namespace NPEU\Component\Researchprojects\Administrator\View\Researchprojects;
...
class HtmlView extends BaseHtmlView {
    ...
    */
    ...
    /**
     * Display the main "Researchprojects" view
     *
    ...
    function display($tpl = null) {
        ...
        $this->canDo = ContentHelper::getActions('com_researchprojects');
    ...
    protected function addToolBar()
    {
        ...
        if ($this->canDo->get('core.edit')) {
            ToolBarHelper::editList('researchproject.edit', 'JTOOLBAR_EDIT');
        }


        if (!$this->isEmptyState && ($this->canDo->get('core.edit.state'))) {
            if ($this->canDo->get('core.delete')) {
                //ToolBarHelper::deleteList('', 'researchprojects.delete', 'JTOOLBAR_DELETE');
                if ($this->state->get('filter.published') != -2) {
                    ToolBarHelper::deleteList('', 'researchprojects.trash', 'JTOOLBAR_DELETE');
                }
            }

            if ($this->canDo->get('core.edit') || Factory::getApplication()->getIdentity()->authorise('core.manage', 'com_checkin')) {
                ToolBarHelper::checkin('researchprojects.checkin');
            }
        ...
        if (!$this->isEmptyState && $this->state->get('filter.published') == -2 && $this->canDo->get('core.delete')) {
            ToolBarHelper::deleteList('', 'researchprojects.delete', 'JTOOLBAR_EMPTY_TRASH');
            /*$toolbar->delete('researchprojects.delete', 'JTOOLBAR_EMPTY_TRASH')
