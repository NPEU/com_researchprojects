...
class JFormFieldTopics extends JFormFieldList
{
	...
	protected function getInput()
	{
        ...
        . 'data-custom_group_text="' . JText::_('COM_RESEARCHPROJECTS_CONFIG_TOPICS_GROUP_LABEL') . '" '
        . 'data-no_results_text="' . JText::_('COM_RESEARCHPROJECTS_CONFIG_TOPICS_ADD_NEW') . '"';
        #. 'data-placeholder="' . JText::_('COM_RESEARCHPROJECTS_CONFIG_TOPICS_TYPE_SELECT') . '"';
    ...
    protected function getOptions()
    {
        ...
        if ($i > 0) {
            ...
            $options[0]->text = JText::_('COM_RESEARCHPROJECTS_CONFIG_TOPICS_EMPTY');
        }
        return $options;
    }
