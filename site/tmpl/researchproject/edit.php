...
<form action="<?php echo $uri; ?>" method="post" name="researchprojects_form" id="<?php echo $form_id; ?>" class="">
    <?php
    ...
    <fieldset<?php echo $inputs_fieldset_class; ?>>
        ...
        <input type="hidden" name="view" value="researchproject" />
    ...
    <fieldset>
        ...
        <?php endif; ?><?php endforeach; ?>
        <?php /*
        <button class="btn" type="submit"><?php echo Text::_('COM_RESEARCHPROJECTS_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo Route::_('index.php?option=com_researchprojects'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        */ ?>
        <button type="submit" name="task" value="researchproject.save"><strong><?php echo Text::_('COM_RESEARCHPROJECTS_SUBMIT_LABEL'); ?></strong></button>
        <?php if (!empty($item_id)) : ?>
        <button type="submit" name="task" value="researchproject.cancel"><?php echo Text::_('JCANCEL') ?></button>
        <?php else : ?>
        <a href="<?php echo Route::_('index.php?option=com_researchprojects&task=researchproject.abort'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        <?php endif; ?>
    </fieldset>
</form>
