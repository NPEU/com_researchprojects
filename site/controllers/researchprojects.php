...
class ResearchProjectsControllerResearchProject extends JControllerForm
{
    ...
    protected function allowEdit($data = array(), $key = 'id')
    {
        ...
        if (!isset($data['created_by'])) {
            if ($record_id > 0) {
                $db = JFactory::getDbo();
                $db->setQuery('SELECT created_by FROM #__researchprojects WHERE ' . $key . ' = ' . $record_id);
        ...
        //$t = $user->authorise('core.edit.own', 'com_researchprojects.' . $record_id);
     ...
     */
    public function getModel($name = 'researchproject', $prefix = '', $config = array('ignore_request' => true))
    {
