...
class ResearchprojectModel extends \NPEU\Component\Researchprojects\Administrator\Model\ResearchprojectModel {
    ...
    /**
     * Get the researchproject
     * @return object The researchproject to be displayed to the user
     */
    /*public function getItem($pk = NULL)
    {
        if (!isset($this->item) || !is_null($pk))
        {
            $id    = $pk ?: $this->getState('researchproject.id');
            $db    = $this->getDatabase();
    ...
    /*public function getTable($name = 'Researchproject', $prefix = 'administrator', $options = array())
    {
