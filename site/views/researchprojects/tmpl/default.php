...
?>
<p>
<a href="<?php echo JRoute::_('index.php?option=com_researchprojects&task=researchproject.add'); ?>">Add new</a>
</p>
<table class="table table-striped table-hover" id="<?php echo $table_id; ?>">
    <thead>
        <tr>
            ...
            <th width="40%">
                <?php echo JText::_('COM_RESEARCHPROJECTS_RECORDS_ALIAS'); ?>
            </th>
            <th width="10%">
                <?php echo JText::_('COM_RESEARCHPROJECTS_RECORDS_ACTIONS'); ?>
            </th>
            <?php /*<th width="10%">
