...
<script type="text/javascript">
    Joomla.submitbutton = function(task)
    {
        ...
        if (task == 'researchproject.cancel') {
...
<form action="<?php echo $route; ?>" method="post" name="researchprojects_form" id="<?php echo $form_id; ?>" class="">
<?php
...
?>
    <fieldset class="three-quarters push--one-quarter">
        ...
        <?php endif; ?><?php endforeach; ?>
        <?php /*
        <button class="btn" type="submit"><?php echo JText::_('COM_RESEARCHPROJECTS_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo JRoute::_('index.php?option=com_researchprojects'); ?>"><?php echo JText::_('JCANCEL') ?></a>
        */ ?>
        <button class="btn" type="submit" onclick="return Joomla.submitbutton('researchproject.save')"><?php echo JText::_('COM_RESEARCHPROJECTS_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo JRoute::_('index.php?option=com_researchprojects'); ?>" onclick="return Joomla.submitbutton('researchproject.cancel')"><?php echo JText::_('JCANCEL') ?></a>
    </fieldset>
</form>
