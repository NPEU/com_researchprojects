...
/**
 * ResearchProjects Router
 */
class ResearchProjectsRouter extends JComponentRouterBase
{
    /**
     * Build the route for the com_researchprojects component
     *
    ...
    public function parse(&$segments)
    {
        ...
        $state_ids = $app->getUserState('com_researchprojects.edit.researchproject.id');
        ...
        /*if ($segments[0] == 'edit') {
            ...
            if ($state_ids == null || (is_array($state_ids) && !in_array($segments[1], $state_ids))) {
                $vars['task'] = 'researchproject.edit';
            }
            ...
            if (isset($segments[2]) && $segments[2] == 'save') {
                $vars['task'] = 'researchproject.save';
            }
...
/**
 * ResearchProjects router functions
 *
 ...
 */
function researchprojectsBuildRoute(&$query)
{
    $router = new ResearchProjectsRouter;
 ...
 * @deprecated  4.0  Use Class based routers instead
 */
function researchprojectsParseRoute($segments)
{
    $router = new ResearchProjectsRouter;
